      ...
      children: [
        ...
        Row(
          children: [
            Expanded(
                child: AppInfoField(
                    label: "City", value: item.billingCity ?? "")),
            const SizedBox(width: 10),
            Expanded(
                child: AppInfoField(
                    label: "State", value: item.billingState ?? "")),
          ],
        ),
        ...
        Row(
          children: [
            Expanded(
                child: AppInfoField(
                    label: "Pincode", value: item.billingPincode ?? "")),
            const SizedBox(width: 10),
            Expanded(
                child: AppInfoField(
                    label: "Country", value: item.billingCountry ?? "")),
          ],
        ),
        const SizedBox(height: 10),
        Row(
          children: [
            Expanded(
                child: AppInfoField(
                    label: "Billing Phone",
                    value: item.billingPhoneNumber ?? "")),
            const SizedBox(width: 10),
            Expanded(
                child: AppInfoField(
                    label: "Billing Person",
                    value: item.billingPersonName ?? "")),
          ],
        ),
      ],
    );
