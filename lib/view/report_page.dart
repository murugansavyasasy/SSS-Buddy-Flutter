          ...
          tripsAsync.whenData((trips) {
            ...
            return Padding(
              ...
              child: Row(
                children: [
                  _SummaryChip(
                      label: 'Total', count: trips.length, color: AppColors.primary),
                  const SizedBox(width: 8),
                  _SummaryChip(label: 'Closed', count: closed, color: Colors.green),
                  const SizedBox(width: 8),
                  _SummaryChip(label: 'Open', count: open, color: Colors.orange),
                ],
              ),
            );
          }).value ??
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              children: [
                _TimeInfo(
                    label: 'Start', time: trip.start_time, icon: Icons.play_circle_outline),
                const SizedBox(width: 8),
                Expanded(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text('${visits.where((v) => v.school_name != null).length} Visit(s)',
                      style: TextStyle(
            ...
            if (visit.reasonOfVisit != null &&
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 4),
                  Expanded(
                    child: Text(visit.reasonOfVisit!,
                        style: TextStyle(
