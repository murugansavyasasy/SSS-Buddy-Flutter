            ...
            body: Column(
              children: [
                ToolbarLayout(
                  ...
                  onSearch: (query) =>
                      ref.read(schooldocumentsviewProvider.notifier).filter(query),
                ),
                Expanded(
                  child: Container(
                    ...
                    child: schooldocumentsAsync.when(
                      ...
                      data: (list) {
                        ...
                        for (final item in list) {
                          final key = item.project_type.isEmpty ? 'Videos' : item.project_type;
                          ...
                          itemBuilder: (context, i) {
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                ...section.value.map((item) => SchoolDocumentCard(item: item)),
                              ],
                            );
                          },
                        );
